...
import { createManufacturingOrder, getVariantBom, saveVariantBom } from '../../../api/manufacturing';
...
export default function CreateManufacturingOrderPage() {
  ...
  // Get BOM automatically on choosing the produced variant
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 pb-12" dir="rtl">
      ...
      <PageHeader
        ...
        subtitle="تحديد المواد الخام ومستلزمات الإنتاج للحصول على منتج نهائي وتحديث المخزون"
        actions={
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-border">
                      {items.map((item, idx) => {
                        ...
                        const isLow = item.currentStock < parseFloat(item.quantity || 0);
        ...
        <div className="space-y-6 lg:sticky lg:top-20">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span>{submitting ? 'جاري إنشاء الأمر...' : 'تأكيد أمر التصنيع'}</span>
            </Button>
