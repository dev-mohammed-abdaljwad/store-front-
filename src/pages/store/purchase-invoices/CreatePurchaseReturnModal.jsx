...
import { createPurchaseReturn, searchPurchaseInvoices } from '../../../api/purchaseInvoices';
...
export default function CreatePurchaseReturnModal({ onClose, onSuccess }) {
  ...
  const createMutation = useMutation({
    mutationFn: (payload) => createPurchaseReturn(payload),
    onSuccess: () => {
      ...
      <div className="my-4 w-full max-w-4xl rounded-xl bg-white shadow-xl sm:my-8">
        <div className="flex items-start justify-between gap-3 border-b border-border p-4 sm:items-center sm:p-6">
          <div>
            ...
            <p className="mt-0.5 text-sm text-text-muted">تسجيل بضاعة مرجعة إلى المورد</p>
          </div>
